...
namespace centre_soutien.Migrations
{
    ...
    [Migration("20250620180356_AddEtudiantCodeField")]
    partial class AddEtudiantCodeField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("centre_soutien.Models.Groupe", b =>
                {
                    ...
                    b.HasIndex("NomDescriptifGroupe", "IDMatiere", "IDProfesseur")
                        .IsUnique()
            ...
            modelBuilder.Entity("centre_soutien.Models.SeancePlanning", b =>
                {
                    ...
                    b.Property<string>("DateDebutValidite")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("DateFinValidite")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("IDGroupe", "JourSemaine", "HeureDebut")
                        .IsUnique()
                        .HasDatabaseName("IX_Seances_Groupe_Jour_HeureDebut_Unique");

                    b.HasIndex("IDSalle", "JourSemaine", "HeureDebut")
                        .IsUnique()
            ...
            modelBuilder.Entity("centre_soutien.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstActif = true,
                            Login = "admin",
                            MotDePasseHashe = "nlJFt6/bDjrGLBcd/oJoeQ==;100000;xhvXeJWxAJ/AinHfJbYjDkQAtafY6NjGmgejFvxCL4I=",
