...
namespace centre_soutien.Migrations
{
    ...
    [Migration("20250601150718_ConfigureSeancePlanningNotes")]
    partial class ConfigureSeancePlanningNotes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("centre_soutien.Models.SeancePlanning", b =>
                {
                    ...
                    b.HasIndex("IDGroupe", "DateSeance", "HeureDebut")
                        .IsUnique()
                        .HasDatabaseName("IX_Seances_Groupe_Date_HeureDebut_Unique");

                    b.HasIndex("IDSalle", "DateSeance", "HeureDebut")
                        .IsUnique()
                        .HasDatabaseName("IX_Seances_Salle_Date_HeureDebut_Unique");
